Shader "Sprites/Outline1"
{
    Properties
    {
		[PerRendererData] _MainTex ("Sprite Texture", 2D) = "white" {}
		_Color ("Main texture Tint", Color) = (1,1,0.4858491,1)
        ...
        _Thickness ("Width (Max recommended 100)", float) = 6
		...
		_SolidOutline ("Outline Color Base", Color) = (1,1,0.4858491,1)
